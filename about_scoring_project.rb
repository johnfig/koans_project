...
def score(dice)
  ...
  # I need to come back and write a better test
  # this is inadequate because you can roll above a 6
  # All this does is test the scores work
  # -John Fig
